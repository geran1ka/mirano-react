          ...
          <figure className="hero__group-image">
            <picture className="hero__image hero__image_left">
              ...
              <img
                ...
                alt="Букет цветов в банке. В бкете ярко-ораньжевые розы, ораньжевые тюльпаны
                и львиный зев. Дополнительно в композию включены белые цветы и зеленые элементы,
            ...
            <svg
              ...
              role="img"
              aria-label="Букет цветов в вазе, включающий нежные розовые розы, розовые хризантемы
              и другие цветы пастельных цветов, размещенные в беловй вазе в форме головы."
              width="680"
              height="588"
              viewBox="0 0 680 588"
              fill="none"
              ...
              <clipPath id="hero">
                <path
                  d="M680 112.187C680 137.954 653.568 161.688 609.146 180.61C653.568 211.682 680
                250.658 680 292.973C680 335.869 652.836 375.335 607.304 406.613C652.836 425.66 680
                449.692 680 475.813C680 537.649 527.777 587.776 340 587.776C152.223 587.776 0 537.649
                0 475.813C0 449.692 27.1636 425.66 72.6961 406.613C27.1636 375.335 0 335.869 0 292.973C0
                250.658 26.4319 211.682 70.854 180.61C26.4319 161.688 0 137.954 0 112.187C0 50.3515 152.223
                0.223633 340 0.223633C527.777 0.223633 680 50.3515 680 112.187Z"
                />
              </clipPath>
            ...
            <picture className="hero__image hero__image_right">
              ...
              <img
                ...
                alt="Букет цветов в банке. В бкете ярко-ораньжевые розы, ораньжевые тюльпаны и львиный
                зев. Дополнительно в композию включены белые цветы и зеленые элементы, придающие букету
          ...
          <form className="subscribe__form" action="#">
            ...
            <button
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M0.166687 6.66667C0.78502 6.66667 1.70835 6.05583 2.48335 5.4375C3.48335 4.6425
                  4.35585 3.6925 5.02169 2.60333C5.52085 1.78667 6.00002 0.796667 6.00002 0M6.00002
                  0C6.00002 0.796667 6.47919 1.7875 6.97835 2.60333C7.64502 3.6925 8.51752 4.6425
                  9.51585 5.4375C10.2917 6.05583 11.2167 6.66667 11.8334 6.66667M6.00002 0V20"
                  stroke="white"
                />
              </svg>
            </button>
              ...
              <a
                ...
                <svg
                  ...
                  <path
                    ...
                    17.7879 12.8853 17.1509C11.7591 16.4115 12.4871 16.002 13.1355 15.3423C13.3061 15.1716
                    16.2181 12.5212 16.275 12.2824C16.2829 12.2462 16.2818 12.2086 16.2719 12.173C16.262
                    12.1373 16.2436 12.1045 16.2181 12.0776C16.1499 12.0208 16.0589 12.0435 15.9792
                    12.0549C15.8769 12.0776 14.2844 13.1355 11.179 15.2285C10.724 15.5356 10.3145 15.6949
                    9.9505 15.6835C9.541 15.6721 8.7675 15.456 8.18738 15.2626C7.47075 15.0351 6.91337
                    14.91 6.95888 14.5119C6.98163 14.3071 7.266 14.1024 7.80063 13.8863C11.1221 12.4416
              ...
              <a className="footer__link" href="#" aria-label="канал в youtube">
                <svg
                  ...
                  <path
                    ...
                    21.9799C18.5267 22.0616 17.1384 22.0966 15.855 22.0966L14 22.1666C9.11171 22.1666
                    6.06671 21.9799 4.86504 21.6533C3.81504 21.3616 3.13837 20.6849 2.84671 19.6349C2.69504
                    19.0866 2.59004 18.3516 2.52004 17.4183C2.43837 16.4849 2.40337 15.6799 2.40337
                    14.9799L2.33337 13.9999C2.33337 11.4449 2.52004 9.56659 2.84671 8.36492C3.13837
              ...
              <a className="footer__link" href="#" aria-label="группа в вк">
                <svg
                  ...
                  <path
                    ...
                    17.3355C19.633 17.499 19.3486 17.5796 19.2515 17.5867H17.4741C17.3509 17.5867
                    17.0926 17.5547 16.7798 17.339C16.5392 17.1708 16.3023 16.8947 16.0712 16.6257C15.7264
                    16.2252 15.4278 15.8792 15.1268 15.8792C15.0886 15.8792 15.0506 15.8852 15.0143
                    15.897C14.7868 15.9705 14.4953 16.2951 14.4953 17.1601C14.4953 17.4303 14.282
                    17.5855 14.1315 17.5855H13.3175C13.0402 17.5855 11.5958 17.4883 10.3162 16.1387C8.74973
                    14.4858 7.3397 11.1705 7.32785 11.1397C7.23898 10.9252 7.42264 10.8103 7.62289
                    10.8103H9.41801C9.65736 10.8103 9.73556 10.956 9.79006 11.0852C9.85405 11.2356
                    10.0887 11.834 10.4737 12.507C11.0982 13.6042 11.4809 14.0498 11.7878 14.0498C11.8453
                    14.0491 11.9019 14.0344 11.9525 14.0071C12.353 13.7843 12.2783 12.3565 12.2606
                    12.0603C12.2606 12.0046 12.2594 11.4217 12.0544 11.142C11.9075 10.9394 11.6575
                    10.8624 11.5058 10.834C11.5672 10.7493 11.6481 10.6806 11.7416 10.6337C12.0165
                    10.4963 12.5118 10.4761 13.0035 10.4761H13.2772C13.8104 10.4832 13.9479 10.5176
                    14.141 10.5662C14.532 10.6598 14.5403 10.9122 14.5059 11.776C14.4953 12.0212 14.4846
                    12.2985 14.4846 12.6255C14.4846 12.6966 14.4811 12.7724 14.4811 12.853C14.4692 13.2926
                    14.455 13.7915 14.7654 13.9964C14.8059 14.0218 14.8527 14.0354 14.9005 14.0355C15.0083
                    14.0355 15.333 14.0355 16.2122 12.5272C16.4833 12.0417 16.719 11.5372 16.9172
                    11.0176C16.935 10.9868 16.9871 10.892 17.0487 10.8553C17.0942 10.8321 17.1446
